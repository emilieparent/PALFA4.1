...
Modified by Emilie Parent - July 2019 
theano does not support downsample anymore -> use signal.pool instead
...
class LeNetConvPoolLayer(object):
	...
	# !! downsample now deprecated -> using pool.pool_2d() instead
